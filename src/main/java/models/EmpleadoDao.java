...
public class EmpleadoDao implements DaoInterface<Empleado> {
	...
	public Empleado get(Empleado empleado) {
		...
		try {
			...
			if (rs.next()) {
				newEmpleado = new Empleado(rs.getString("nif"), rs.getString("nombre"), rs.getString("telefono"),
						rs.getString("correo"), rs.getString("codigo"));
			} else {
	...
	public List<Empleado> getAll() {
		...
		try {
			...
			while (rs.next()) {
				Empleado newEmpleado = new Empleado(rs.getString("nif"), rs.getString("nombre"),
						rs.getString("telefono"), rs.getString("correo"), rs.getString("codigo"));
