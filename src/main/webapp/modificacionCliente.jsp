	...
	%>	<div>
		<table>
			...
			<form action="modificacionCliente.jsp" method="POST">
				<tr>
					<td>
					<strong><label for="clientNif">Nif</label></strong>
					</td>
					<td>
						<input type="text" id="clientNif" name="clientNif"  value="<%= client.getNif() %>" >
					</td>	
				</tr>
				<tr>
					<td><strong><label for="clientName">Nombre</label></td></strong>	
					<td>
						<input type="text" id="clientName"  name="clientName"  value="<%= client.getNombre()  %>" >
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="clientPhone"  name="clientPhone"  value="<%= client.getTelefono()  %>" >
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="clientEmail"  name="clientEmail"  value="<%= client.getCorreo()  %>" >
					</td>
				</tr>
				<tr>
					<td>
						<input type="hidden" id="clientOldNif"  name="clientOldNif"  value="<%= client.getNif()%>" >
					</td>
				</tr>
				...
				<tr>
					...
					<td></td>
					<td>
						<a href="clientes.jsp" class="boton-volver">Volver</a>
					</td>
				</tr>
			</tbody>
		</table>		
